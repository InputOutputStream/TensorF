...
all: gpt2 llama smollm transformer benchmark
...
$(BIN)/basic_tests: basic_tests.cpp
	@echo "[CXX] $< → $@"
	$(CXX) $(CXXFLAGS) $< -o $@ $(LDFLAGS)
...
help:
	...
	@echo "  make server         Serveur federated (besoin de include/Network/server.cpp)"
	@echo "  make client         Client federated  (besoin de include/Network/client.cpp)"
